  ...
  return (
    <div className="bg-background min-h-screen px-3 py-4 sm:px-4 sm:py-8 lg:px-8">
      <div className="container mx-auto max-w-2xl">
        ...
        <Card>
          <CardHeader className="space-y-1.5 p-4 pb-2 sm:space-y-2 sm:p-6 sm:pb-3">
          ...
          <CardContent className="p-4 sm:p-6">
            ...
            {/* Authentication Section - Show if not signed in */}
            {!session && (
              <Alert
                className={
                  form.allowAnonymous
                    ? "border-muted-foreground/30 bg-muted/30 mb-4"
                    : "border-primary/50 bg-primary/5 mb-6"
                }
              >
                <AlertCircle
                  className={
                ...
                <AlertDescription>
                  <div className="flex flex-col gap-3">
                    <span className="text-sm font-medium">
                      {form.allowAnonymous
                        ? "Sign in to link your response to your account (optional)"
